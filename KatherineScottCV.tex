...
\href{mailto:katherineAScott@gmail.com}{Katherine Ann Scott} \\

3690 Broadway     & \textit{Voice:} (734) 358-0175 \\
Apartment 2  &\textit{E-mail:} \\
New York, NY 10031  USA  &\ \href{mailto:katherineAScott@gmail.com}{ katherine.a.scott@gmail.com}\\
&\ \href{http://www.kscottz.com}{www.kscottz.com} \\   
...
\item[] Master of Science in 
        ...
        \begin{innerlist}
        \item Areas of Study: Computer Vision and Graphics.\newline \newline
        \end{innerlist}
\end{outerlist}
...
\item 2001 Secretary Student Libertarians
\item 2001 Secretary Students Promoting Export-Oriented Economic Decisions (SPEED)
...
\item[] \textbf{Languages:} \\
 C++, C,  C\#, Java, Lua, Common Lisp, UNIX shell scripting, MySQL.

\item[] \textbf{Libraries:} \\
OpenCV, OpenGL, OGRE, Boost, TinyXML, COM, MFC, GoblinXNA, Android SDK.

\item[] \textbf{Tools and Environments:} \\
         Unix, Linux, Windows, OS X, CVS, SVN, Trac, Visual Studio, NetBeans, Eclipse, EMacs, XEMacs, Matlab. 
...
\begin{lonelist}
\item[] Community gardening (5 years with Ann Arbor's Project Grow Community Gardens), aquariums and aquaculture, collecting plants (especially cacti and succulents), hiking and camping, and paper crafts.
\blankline
\item[] Prior to moving to New York I spent  five years living in and organizing Arbor Vitae, a 45 year old historic cooperative loft in Ann Arbor, Michigan. Arbor Vitae currently houses one of the largest libraries of world peace and peace activism materials, and frequently hosts community arts events.   
\end{lonelist}
