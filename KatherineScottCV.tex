...
\href{http://goo.gl/maps/QI0cn}{1701 Dexter Ave.}                      & \textit{Voice: } (734) 358-0175 \\
\href{http://goo.gl/maps/QI0cn}{Ann Arbor, MI, 48103 USA}              & \textit {Web: }\href{http://www.kscottz.com}{www.kscottz.com} \\
...
\item Designed custom computer vision applications for industrial and manufacturing customers covering such topics as meteorology, image recognition, temporal signal processing, and color space analysis. This process included everything from initial system design and specification all the way through final testing, validation, and deployment.
...
\begin{outerlist}
\item I am an avid gardener with a passing interest \href{http://www.youtube.com/watch?v=KUyKp_cIFmc}{aquariums} and aquaculture, and plant collecting. I completed five years with Ann Arbor's \href{http://www.projectgrowgardens.org/}{Project Grow Community Gardens}, and two years volunteering with the \href{https://maps.google.com/maps/ms?ie=UTF8&oe=UTF8&msa=0&msid=203025543716789179192.000450c62f0577e61522e}{Serenity Community Garden} in Harlem, New York. 
